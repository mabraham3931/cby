...
function wcmSurveyPlaceInFooter() {
  ...
  $('#section-footer').append("<a style='position: fixed; top: 0px;' id='wcm-survey-target-id'></a>" + Drupal.settings.wcmSurvey.surveyPopup);
...
function wcmSurveyProcess() {
  ...
  if (typeof Drupal.settings.wcmSurvey !== 'undefined') {
    ...
    if (showSurvey) {
      ...
      Drupal.settings.survey = cbSettings;
      $.colorbox(cbSettings);
...
Drupal.behaviors.wcmSurvey = {
  attach: function(context) {
    wcmSurveyPlaceInFooter();
    if (typeof Drupal.settings.wcmSurvey !== 'undefined' &&
        typeof Drupal.settings.wcmSurvey.pageDepth !== 'undefined' &&
        parseInt(Drupal.settings.wcmSurvey.pageDepth) > 0) {
